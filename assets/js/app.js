 ...
 * @param {string} eventType aEvent Type ex: "click", "mouseover"
...
searchField.addEventListener("input", function (){
    ...
    //searchTimeout ?? clearTimeout(searchField);
            ...
            fetchData(url.geo(searchField.value), function (locations){
                ...
                searchResult.innerHTML = `
                    ...
                    for(const { name, lat, lon, country, state} of locations) {
                        ...
                        <a href="#/weather?lat=${lat}&lon=${lon}" class="item-link has-state" aria-label="${name} weather" data-search-result></a>
                        `;
